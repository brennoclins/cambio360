...
export function Dashboard() {
  ...
  const [currentView, setCurrentView] = useState<ViewType>('mercado')
        ...
        <main className="max-w-7xl mx-auto px-4 sm:px-6 py-6 space-y-6">
          {currentView === 'mercado' ? (
            <>
              ...
              <div className="hidden sm:grid sm:grid-cols-1 xl:grid-cols-3 gap-6">
              ...
              <div className="sm:hidden">
                <div className="p-4 rounded-xl bg-[#0f1a16] border border-white/5">
                  <h3 className="text-sm font-semibold text-white mb-3">Mercados</h3>
                  <div className="space-y-2">
                    {['principais', 'crypto', 'ptax'].map(cat => {
                      const isActive = activeCategory === cat
